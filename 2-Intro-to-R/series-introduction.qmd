...
+-------------+-------------------------------------------------------------------------------------------------------------+
| Session 3   | [Manipulating and Analyzing Data with Tidyverse](./manipulating-analyzing-and-exporting-with-tidyverse.qmd) |
+-------------+-------------------------------------------------------------------------------------------------------------+
| Session 4   | [Data Visualization with ggplot2](./data-visualization.qmd)                                                 |
+-------------+-------------------------------------------------------------------------------------------------------------+
